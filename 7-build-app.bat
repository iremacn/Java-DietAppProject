...
rd /S /Q "dietapp-app\target\site\coverxygen"
rd /S /Q "dietapp-app\target\site\coveragereport"
rd /S /Q "dietapp-app\target\site\doxygen"
...
echo Copy the "README.md" file to "dietapp-app\src\site\markdown\readme.md"
